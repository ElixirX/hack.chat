var frontpage = [
	...
	"",
	"",
	"To prevent you from being impersonated I use trips. Type #whatever after your username to get your personal trip.",
	"A trip is made from the salt and is a 6 character long code to identify you",
	"",
	"",
	"Whitespace is preserved, so source code can be pasted verbatim.",
	"",
	"There's some KaTeX stuff too, just enclose it in dollar signs.",
	"Here's an example of KaTeX for you",
	"",
